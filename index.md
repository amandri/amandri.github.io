...
[WP link](https://www.dropbox.com/scl/fi/mxt3mkaes7f8j0tcgb9dj/ARZ_nontrade.pdf?rlkey=zgw6pi7j5btv6pnrtkofv9bdt&dl=0).
...
Abstract: \
*To explain the cross-section of asset returns, a "zoo" of economic factors that are not portfolio excess returns has been proposed. In contrast to traded factors, the non-traded factors tend to have smaller correlations with the asset returns. Standard inference on risk premium tends to be more fragile, and the issue of weak identification might be exacerbated by the degree of model misspecification. Yet, robust inference has often been overlooked by many empirical studies, while limited efforts have been devoted to "domesticating" such factors. After comprehensively re-evaluating the non-traded factor zoo, we find that the vast majority of the original model specifications published in top academic journals suffer from the aforementioned fragilities. Robust inference strongly shows that most of the proposed nontraded factors are unpriced in the commonly used test portfolios. The findings are more drastic with the market factor as additional control. However, when summarizing the universe of the non-traded factors via PCA, we find that the zoo does carry some non-zero pricing information.*
